...
<html>
	<head>
		...
		<script>
			$(document).ready(function() {
				...
				// Read the input filenames from POST request in PHP
				var movcsv = "<?php echo $_POST['csvfile'] ?>";
				var movvid = "<?php echo $_POST['mp4file'] ?>";
				var movaud = "<?php echo $_POST['mp3file'] ?>";
				movan.loadNew(movcsv);
				
				$("#vidPlayerSrc").attr("src", movvid);
				$("#vidPlayer").load();
				
				$("#audPlayerSrc").attr("src", movaud);
				$("#audPlayer").load();
	...
	<body>
		...
		<div id="header" style="clear:both;">
			<h1 style="float: left;">Movement Analytics Platform</h1>
			<h4 style="float: right;"><div id="filenamelael">
						files: <?php echo $_POST['csvfile'] ?> , <?php echo $_POST['mp4file'] ?>
					</div></h4>
		</div>
		...
		<div id="canCont">
			<div id="maintabs">
				...
				<div id="video">
					<video width="50%"  id="vidPlayer" controls>
						<source src="" id = "vidPlayerSrc" type="video/mp4">
 						  							Your browser does not support the video tag.
					</video>
				</div>
				<div id="audio">
					<audio id="audPlayer" width="80%" controls>
 					 <source src="" id = "audPlayerSrc" type="video/mp4">
		...
		<div id="footer" style="clear:both;text-align:center;padding-top:20px;">
			<small>(C) Omid Alemi - Winter 2014</small>
		</div>
	</body>
</html>
